...
def is_identity_matrix(M):
    ...
    for e in range(len(M)):
        ...
        for i in range(len(M)):
            if e == i:
                sub_columns.append(1)
            else:
                sub_columns.append(0)
        columns.append(sub_columns)
    return M == columns and len(M) == len(columns)
...
# ALTERNATIVE SOLUTION 1 FOR RECOGNIZE IDENTITY MATRIX
...
# ALTERNATIVE SOLUTION 2 FOR RECOGNIZE IDENTITY MATRIX
